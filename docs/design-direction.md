...
| Messages | Private bot questions for the connected account. The numbered badge counts unread conversations and clears as they are opened. Each entry opens a conversation page with a post link, message history and a growing reply field. Drafts survive navigation and account switches within the preview. Send messages directly. Amber applies its changes and shows the diff in the conversation, with a link to the updated post. No approval step. The sample includes a complete question, reply and applied update. Visitors see a sign-in prompt; accounts without conversations see an empty inbox. |
