...
const glyphs = {
  ...
  memory: (
    <>
      <path d="M7 4.5h10A2.5 2.5 0 0 1 19.5 7v12.5h-11A2.5 2.5 0 0 1 6 17V7a2.5 2.5 0 0 1 2.5-2.5" />
      <path d="M8.5 19.5A2.5 2.5 0 0 1 6 17c0-1.4 1.1-2.5 2.5-2.5h11M10 8.5h5" />
    </>
  ),
  link: (
    <path
